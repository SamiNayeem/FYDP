  ...
  return (
    <div className='mt-40'>
        ...
        <div className="container mx-auto h-80  mt-10 flex ml-80">
            ...
            <div className="bg-blue-600 p-4 rounded-lg shadow-md text-white w-60">
            ...
            <div className="ml-20 grid grid-cols-1 md:grid-cols-3 gap-4">
               <div className="bg-white p-4 rounded-lg shadow-md w-60 hover:bg-blue-500 hover:text-white">
