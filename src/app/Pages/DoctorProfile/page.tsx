...
import DoctorUserImage from 'public/DoctorUserImage.png'
          ...
          <div className="flex flex-wrap justify-center">
            <div className="w-full lg:w-3/12 px-4 lg:order-2 flex justify-center">
              <div className="ml-auto">
                    ...
                    <Image src={DoctorUserImage} alt="doctor profile pic" height={300} width={300} className="shadow-xl flex rounded-full align-middle border-none relative -m-16 -ml-20 lg:-ml-16 max-w-150-px" ></Image>
              </div>
            </div>
            ...
            <div className="w-full lg:w-4/12 px-4 lg:order-1">
              <div className="flex justify-center py-4 lg:pt-4 pt-8">
                <div className="mr-4 p-3 text-center">
                  <span className="text-xl font-bold block uppercase tracking-wide text-blueGray-600">Professor</span><span className="text-sm text-blueGray-400">Designation</span>
                </div>
                <div className="mr-4 p-3 text-center">
