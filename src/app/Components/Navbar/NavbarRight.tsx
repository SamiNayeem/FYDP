...
const NavbarRight =()=>{
    return(
		...
		<ul className="hidden absolute top-1/2 left-3/4 transform -translate-y-1/2 -translate-x-3/4 lg:flex lg:mx-auto lg:items-center lg:w-auto lg:space-x-5">
			<li><a className="text-sm text-black-400 hover:text-blue-500 font-bold" href="#">Home</a></li>
            ...
            <div className="flex flex-1">
                ...
                <div
                    className="inline-block h-[30px] min-h-[1em] w-0.5  bg-black opacity-100 ">

                </div>

            </div>
            </li>
			<li><a className="text-sm text-black-400 hover:text-blue-500 font-bold" href="#ourServices">Our Services</a></li>
			{/* <li className="text-black-300">
				<svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" className="w-4 h-4 current-fill" viewBox="0 0 24 24">
					<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
				</svg>
			...
			<li><a className="text-sm text-black-400 hover:text-blue-500 font-bold" href="#faq">FAQ</a></li>
			{/* <li className="text-black-300">
				<svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" className="w-4 h-4 current-fill" viewBox="0 0 24 24">
					<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
				</svg>
			...
			<li><a className="text-sm text-bla-400 hover:text-blue-500 font-bold" href="#contactUs">Contacts</a></li>
